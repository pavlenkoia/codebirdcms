...
class Securimage {
  ...
  var $securimage_code_value_name = 'securimage_code_value';
  ...
  function Securimage($name = null)
  {
    ...
    if($name)
    {
        $this->securimage_code_value_name = 'securimage_code_value_'.$name ;
    }
  }
  ...
  function saveData()
  {
    $_SESSION[$this->securimage_code_value_name] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION[$this->securimage_code_value_name]) && !empty($_SESSION[$this->securimage_code_value_name]) ) {
      if ( $_SESSION[$this->securimage_code_value_name] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
//        $_SESSION[$this->securimage_code_value_name] = '';
      } else {
  ...
  {
    if (isset($_SESSION[$this->securimage_code_value_name]) && !empty($_SESSION[$this->securimage_code_value_name])) {
      return $_SESSION[$this->securimage_code_value_name];
    } else {
      return '';
    }
  }
