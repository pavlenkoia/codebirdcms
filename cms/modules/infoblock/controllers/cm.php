...
class InfoblockController_Cm extends Controller_Base
{
    ...
    public function tree()
    {
        ...
        $template->infoblocks = $infoblocks;
    ...
    public function save()
    {
        ...
        try
        {
            ...
            if($object)
            {
                ...
                $cache = SITE_PATH.'files'.DS.'infoblock'.$cache_path.DS.$object->alias;
                if(is_file($cache))
                {
                    unlink($cache);
                }
